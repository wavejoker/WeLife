 ...
 * Generated at: 2017-12-06 11:13:29 UTC
...
public final class item_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("       data-options=\"singleSelect:false,collapsible:true,pagination:true,url:'/product/list',method:'get',pageSize:30,toolbar:toolbar\">\r\n");
      out.write("    <thead>\r\n");
      out.write("        <tr>\r\n");
      ...
      out.write("        \t\t\t\r\n");
      out.write("        \t\t\t// 加载商品描述\r\n");
      out.write("        \t\t\t$.getJSON('/product/query/product/desc/'+data.id,function(_data){\r\n");
      ...
      out.write("        \t\t\t\r\n");
      out.write("        \t\t\t//加载商品规格\r\n");
      out.write("        \t\t\t$.getJSON('/product/param/item/query/'+data.id,function(_data){\r\n");
      out.write("        \t\t\t\tif(_data && _data.status == 200 && _data.data && _data.data.paramData){\r\n");
      out.write("        \t\t\t\t\t$(\"#itemeEditForm .params\").show();\r\n");
      out.write("        \t\t\t\t\t$(\"#itemeEditForm [name=productParams]\").val(_data.data.paramData);\r\n");
      out.write("        \t\t\t\t\t$(\"#itemeEditForm [name= ]\").val(_data.data.id);\r\n");
      out.write("        \t\t\t\t\t\r\n");
      out.write("        \t\t\t\t\t//回显商品规格\r\n");
      ...
      out.write("                \t$.post(\"/rest/product/delete\",params, function(data){\r\n");
      ...
      out.write("        \t    if (r){\r\n");
      out.write("        \t    \tvar params = {\"ids\":ids};\r\n");
      out.write("                \t$.post(\"/rest/product/instock\",params, function(data){\r\n");
      out.write("            \t\t\tif(data.status == 200){\r\n");
