				...
				<div class="cart-thead clearfix">
					<div class="column t-checkbox form">
						<input data-cart="toggle-cb" name="toggle-checkboxes"
							id="toggle-checkboxes_up" type="checkbox" checked="" value="" /><label
						...
						<div id="product_11345721" data-bind="rowid:1"
							...
							<div class="item_form clearfix">
								<div class="cell p-checkbox">
									<input data-bind="cbid:1" class="checkbox" type="checkbox"
										name="checkItem" checked="" value="11345721-1" />
								</div>
								...
								<div class="cell p-quantity" for-stock="for-stock-11345721">
									<div class="quantity-form" data-bind="">
										...
										<input type="text" class="quantity-text"
											...
											value="${cart.num }" id="changeQuantity-11345721-1-1-0" /> <a
					...
					<div class="cart-dibu ui-ceilinglamp-current"
						...
						<div class="control fdibu fdibucurrent">
							<span class="column t-checkbox form"> <input
								...
								id="toggle-checkboxes_down" type="checkbox" checked="checked"
								...
								target="_blank" clstag="clickcart|keycount|xincart|coudanlink"
								id="continue">继续购物</a>
							</span>
						</div>
