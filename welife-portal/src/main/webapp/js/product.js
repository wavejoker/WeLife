...
// var e = 502, i = 358, s = ' <div id="Fqfk_Tip" class="Tip360"
// style="width:auto;"> <div class="Tip_Title"> <em> <img src="' + fq_serverSite
// + 'skin/images/tip_close.jpg" class="Tip_Close"/>
// </em>\u767d\u6761/\u5206\u671f </div> <div class="Tip_Content" id="Tip_fq0">
// <div id="baitiaofenqi" style="position:relative;width:482px;height:330px;">
// </div> </div> </div>', a = ("<div id='c04tip' class='clearfix'
// style='z-index:20000;position:absolute;width:" + (e + 5) + "px;height:" + (i
// + 5) + "px;'><div style='position:absolute;margin:5px 0 0 5px;width:" + e +
// "px;height:" + i + "px;z-index:20001;'>{HTML}</div></div>").replace("{HTML}",
// s), n = $(a);
// n.append(s), $(document.body).prepend(n), $("#Fqfk_Tip").show(),
// el_top_middle($("#c04tip"), 502, 358), $.ajax({url:
// "http://nfa.jd.com/loadFa.js?aid=2_163_5702",dataType: "script",cache: !0}),
// $(".Tip_Close").click(function() {
// $("#c04tip").remove()
// })
}
function showNaBaitiao() {
// var t = 502, e = 358, i = $("<div id='c04tip' class='clearfix'
// style='z-index:20000;position:absolute;width:" + (t + 5) + "px;height:" + (e
// + 5) + "px;'><div style='position:absolute;margin:5px 0 0 5px;width:" + t +
// "px;height:" + e + "px;z-index:20001;'></div></div>"), s = ' <div
// id="Fqfk_Tip" class="Tip360" style="width:auto;width:500px;height:310px;">
// <div class="Tip_Title"> <em><img
// src="http://jd2008.jd.com/purchase/skin/images/tip_close.jpg"
// class="Tip_Close"></em> \u62ff\u767d\u6761 </div> <div class="Tip_Content"
// id="nabaitiao"></div> </div>';
// i.append(s), $(document.body).prepend(i), $("#Fqfk_Tip").show(),
// el_top_middle($("#c04tip"), 502, 358), $(".Tip_Close").click(function() {
// $("#c04tip").remove()
// }), $.ajax({url: "http://nfa.jd.com/loadFa.js?aid=2_163_5480",dataType:
// "script",cache: !0})
}
...
// var t = document.getElementById("Fqfk_Tip"), e =
// $("#InitCartUrl").attr("href");
// t.style.width = "500px";
// var i = "http://baitiao.jd.com/creditUser/list?from=dpy", s = '<div
// class="Tip_Title"> <em> <img src="' + fq_serverSite +
// 'skin/images/tip_close.jpg" class="Tip_Close"/>
// </em>\u767d\u6761/\u5206\u671f </div> <div class="Tip_Content" id="Tip_fq0">
// <div style="position:relative;width:482px;height:310px;"> <img
// src="http://img13.360buyimg.com/da/jfs/t157/107/261896691/42066/92e14669/5385b7edNa8b9b2a3.png"
// /> <a href="http://help.jd.com/help/question-71.html#help211"
// title="\u94f6\u884c\u5206\u671f" style="position:
// absolute;bottom:3px;width:410px;height:32px;left:60px;background:
// url(http://misc.360buyimg.com/lib/img/e/blank.gif);"></a> <a href=' + e + '
// title="\u52a0\u5165\u8d2d\u7269\u8f66"
// style="position:absolute;top:61px;right:11px;width:98px;height:24px;background:
// url(http://misc.360buyimg.com/lib/img/e/blank.gif);"
// clstag="shangpin|keycount|product|initcarturlbt"></a> <a href=' + i + '
// title="\u7acb\u5373\u6fc0\u6d3b"
// style="position:absolute;top:61px;left:146px;width:67px;height:24px;background:
// url(http://misc.360buyimg.com/lib/img/e/blank.gif);"></a> </div> </div>';
   // t.innerHTML = s
}
...
function renew() {
// $.ajax({url: "http://d.360buy.com/oldfornew/get?skuId=" +
// pageConfig.product.skuid,dataType: "jsonp",success: function(t) {
// var e = '<div class="renew-arrgrment"
// style="line-height:200%;height:190px;overflow-y:auto;">
// <p>\u5c0a\u656c\u7684\u5ba2\u6237\uff1a</p>
// <p>\u60a8\u597d\uff01\u6b22\u8fce\u60a8\u53c2\u52a0\u4eac\u4e1c\u5546\u57ce\u201c\u7535\u8111\u4ee5\u65e7\u6362\u65b0\u201d\u6d3b\u52a8\u3002\u4e3a\u4e86\u4fdd\u8bc1\u60a8\u80fd\u591f\u6b63\u5e38\u4eab\u53d7\u4ee5\u65e7\u6362\u65b0\u6d3b\u52a8\u4f18\u60e0\uff0c\u8bf7\u60a8\u4ed4\u7ec6\u9605\u8bfb\u4ee5\u4e0b\u6d3b\u52a8\u7ec6\u5219\uff0c\u786e\u8ba4\u65e0\u8bef\u540e\u518d\u63d0\u4ea4\u4ee5\u65e7\u6362\u65b0\u8ba2\u5355\u3002</p>
// <ul> <li>1.
// \u6d3b\u52a8\u53c2\u4e0e\u5730\u533a\uff1a\u6240\u6709\u4eac\u4e1c\u81ea\u8425\u914d\u9001\u8986\u76d6\u8303\u56f4\uff0c\u5177\u4f53\u8303\u56f4\u8bf7\u67e5\u770b\u4eac\u4e1c\u5e2e\u52a9\u4e2d\u5fc3\uff1b</li>
// <li>2.
// \u4eac\u4e1c\u5546\u57ce\u53c2\u52a0\u6d3b\u52a8\u4ea7\u54c1\uff1a\u4ee5\u4ea7\u54c1\u9875\u9762\u4fe1\u606f\u663e\u793a\u4e3a\u51c6\uff1b</li>
// <li>3.
// \u60a8\u53c2\u52a0\u4ee5\u65e7\u6362\u65b0\u7535\u8111\u8981\u6c42\uff1a\u4efb\u4f55\u54c1\u724c\uff0c\u53ef\u4ee5\u6b63\u5e38\u5f00\u673a\u7684\u7b14\u8bb0\u672c\u7535\u8111\uff1b\u4e0d\u7b26\u5408\u6b64\u6807\u51c6\u7684\u65e7\u7535\u8111\uff0c\u4e0d\u80fd\u53c2\u4e0e\u201c\u4ee5\u65e7\u6362\u65b0\u201d\u6d3b\u52a8\uff1b</li>
// <li>4.
// \u5177\u4f53\u6d3b\u52a8\u89c4\u5219\uff1a\u4ee5\u4eac\u4e1c\u5546\u57ce\u7f51\u7ad9\u9875\u9762\u516c\u793a\u4e3a\u51c6\uff1b</li>
// <li>5.
// \u7b7e\u6536\u6d41\u7a0b\uff1a\u7b7e\u7f72\u4eac\u4e1c\u7535\u8111\u4ee5\u65e7\u6362\u65b0\u53d6\u8d27\u5355\uff0c\u5e76\u628a\u65e7\u7535\u8111\u4ea4\u4ed8\u4eac\u4e1c\u914d\u9001\u5458\uff1b</li>
// <li>6.
// \u9000\u6362\u8d27\u6d41\u7a0b\uff1a\u53c2\u52a0\u6b64\u201c\u4ee5\u65e7\u6362\u65b0\u201d\u65b9\u5f0f\u8d2d\u4e70\u7684\u7b14\u8bb0\u672c\u7535\u8111\u5982\u7533\u8bf7\u9000\u8d27\uff0c\u4eac\u4e1c\u4ec5\u6309\u7167\u6d88\u8d39\u8005\u5b9e\u9645\u652f\u4ed8\u91d1\u989d\u9000\u6b3e\uff0c\u4eac\u4e1c\u4e0d\u518d\u5411\u6d88\u8d39\u8005\u8fd4\u8fd8\u65e7\u7b14\u8bb0\u672c\u7535\u8111\u3002</li>
// </ul></div><div class="renew-btn"> <a href="#none"
// class="css3-btn">\u540c\u610f\u534f\u8bae</a></div>';
// t && t.isOldForNew && ($("#choose-btns").prepend('<div id="choose-btn-renew"
// class="btn"><a href="javascript:;"
// class="btn-renew">\u53c2\u52a0\u4ee5\u65e7\u6362\u65b0<b></b></a></div>'),
// $("#choose-btn-renew").jdThickBox({type: "text",width: 570,height: 240,title:
// "\u4ee5\u65e7\u6362\u65b0\u534f\u8bae",_title:
// "renew_agreement_title",source: e,_con: "renew_aggrement",_close:
// "close_me"}, function() {
// $(".renew-btn .css3-btn").attr("href",
// "http://trade.jd.com/order/getOrderInfo.action?pid=" +
// pageConfig.product.skuid + "&pcount=" + $("#buy-num").val() + "&rid=" + +new
// Date)
// }))
// }})
}
...
// var e = t || G.sku;
// $.ajax({url: "http://chat1.jd.com/api/checkChat?",data: {pid:
// e,returnCharset: "utf-8"},dataType: "jsonp",success: function(t) {
// if (t) {
// pageConfig.im = t;
// var i = t.seller, s = t.code;
// if (i && "" != i && (i = i.replace("&qt;", "'").replace("&dt;", '"')), 1 >
// $("#brand-bar-pop").length && ($("#j-im").length > 0 && $("#j-im").remove(),
// $("#summary-grade .dd #j-im").length > 0 && $("#summary-grade .dd
// #j-im").remove(), (1 == s || 2 == s || 3 == s || 9 == s) && $("#summary-grade
// .dd").append('<a id="j-im" class="djd-im" href="#none"
// clstag="shangpin|keycount|product|imbtn"><b>\u8054\u7cfb\u5ba2\u670d</b></a>')),
// 1 == s)
// $("#online-service").show(), $("#j-im").attr("title", i + "
// \u8054\u7cfb\u5ba2\u670d"), $("#j-im").click(function() {
...
// : "
// \u5382\u5546\u552e\u524d\u54a8\u8be2\u76ee\u524d\u4e0d\u5728\u7ebf\uff01\u8d2d\u4e70\u4e4b\u524d\uff0c\u5982\u6709\u95ee\u9898\uff0c\u8bf7\u5728\u6b64\u9875\u201c\u5168\u90e8\u8d2d\u4e70\u54a8\u8be2\u201d\u4e2d\u5411\u4eac\u4e1c\u5ba2\u670d\u53d1\u8d77\u54a8\u8be2";
// $("#j-im").addClass("d-offline").html("<b>\u7559\u8a00\u54a8\u8be2</b>").attr("title",
// i + a).unbind("click")
// } else
// (3 == s || 9 == s) &&
// ($("#online-service").show().find("b").html("\u8054\u7cfb\u5ba2\u670d"),
// $("#j-im").addClass("d-offline").html("<b>\u7559\u8a00\u54a8\u8be2</b>").attr("title",
// i + "
// \u5ba2\u670d\u76ee\u524d\u4e0d\u5728\u7ebf\uff0c\u60a8\u53ef\u4ee5\u70b9\u51fb\u6b64\u5904\u7ed9\u5546\u5bb6\u7559\u8a00\uff0c\u5e76\u5728\u3010\u6211\u7684\u4eac\u4e1c->\u6d88\u606f\u7cbe\u7075\u3011\u4e2d\u67e5\u770b\u56de\u590d").click(function()
// {
...
// + t + "&callback=getCommentCount",dataType: "script",cache: !0})
        , void 0)
...
// var i = t.extend({start: null,end: null,fixedClass: "nav-fixed",anchor:
// null,targetEle: null,range: 0,onStart: function() {
// },onEnd: function() {
// }}, e), s = t(this), a = s.height(), n = s.width(), o = t('<div
// class="float-nav-wrap"/>');
// return s.css({height: a,width: n}), s.parent().hasClass("float-nav-wrap") ||
// s.wrap(o.css("height", a)), t(window).bind("scroll", function() {
// var e = t(document).scrollTop(), a = s.find("a").eq(0).attr("href"), n =
// i.start || s.parent(".float-nav-wrap").offset().top, o = i.targetEle ?
// t(i.targetEle).offset().top : 1e4;
// e > n && (i.end || o) - i.range > e ? (s.addClass(i.fixedClass), i.anchor &&
// a !== i.anchor && s.find(".toggle-link").attr("href", i.anchor), i.onStart &&
// i.onStart()) : (s.removeClass(i.fixedClass), i.anchor &&
// s.find(".toggle-link").attr("href", "javascript:;"), i.onEnd && i.onEnd())
// }), this
    }
}(jQuery), function(t) {
    var e = function(e, i) {
...
// ,
// $.ajax({url: "http://diviner.jd.com/diviner?" +
// decodeURIComponent($.param(i)),dataType: "jsonp",scriptCharset:
// "utf-8",success: function(t) {
// e.set(t)
// }})
    },set: function(t) {
        function e(t, e) {
...
// G.isPop ? $.ajax({url:
// "http://misc.360buyimg.com/product/js/2012/suits.js",dataType:
// "script",scriptCharset: "gb2312",cache: !0,success: function() {
// "undefined" != typeof Suits && Suits.init(G.sku)
// }}) : $.ajax({url: "http://pi.3.cn/suitinfo/get",data: {id: G.sku,origin:
// 1},dataType: "script",cache: !0,scriptCharset: "utf-8"})
    },renderRecoFittingsHTML: function() {
// var t = G.sku, e = 6728 == G.cat[0] || 653 == G.cat[1] || 830 == G.cat[1], i
// = "-672-6864-1105-717-720-718-719-798-", s = RegExp("-" + G.cat[2] +
// "-").test(i);
// return !G.isJd && e ? !1 : (655 == G.cat[2] ? $.ajax({url:
// "http://rs.jd.com/accessorie/newServiceWhite.jsonp?sku=" + G.sku +
// "&callback=Recommend.cbNewFittings",dataType: "script",cache:
// !0,scriptCharset: "utf-8"}) : 830 == G.cat[1] ? $.ajax({url:
// "http://rs.jd.com/accessorie/accessoryByAccessory.jsonp?sku=" + G.sku +
// "&callback=Recommend.cbNewFittings",dataType: "script",cache:
// !0,scriptCharset: "utf-8"}) : G.cat[2] > 830 && 835 > G.cat[2] || 5012 ===
// G.cat[2] ? $.ajax({url:
// "http://misc.360buyimg.com/product/js/2012/fittingsCamera.js?ver=20140424",dataType:
...
// }}) : 6728 == G.cat[0] && G.isJd ? $.ajax({url:
// "http://misc.360buyimg.com/product/js/2012/fittingsAuto.js?ver=20140424",dataType:
// "script",cache: !0}) :
// $.getJSONP("http://d.360buy.com/fittingInfo/get?skuId=" + t +
// "&callback=Recommend.cbRecoFittings"), void 0)
...
// "true" != t.attr("enabled") ? $.ajax({type: "GET",url:
// "http://club.jd.com/index.php",data: {mod: "ProductComment",action:
// "saveCommentUserfulVote",commentId: i,isUseful: s},dataType: "jsonp",success:
// function(e) {
// if (t.attr("enabled", "true"), 1 == e.status) {
// var i = parseInt(t.attr("title")) + 1;
// t.attr("title", i), s ? t.html("\u6709\u7528(" + i + ")") :
// t.html("\u6ca1\u7528(" + i + ")")
// } else
// alert("\u4e00\u4e2a\u8bc4\u4ef7\u53ea\u80fd\u70b9\u4e00\u6b21\u5466")
// }}) : alert("\u4e00\u4e2a\u8bc4\u4ef7\u53ea\u80fd\u70b9\u4e00\u6b21\u5466")
...
// var t = this;
// $.ajax({url: "http://d.360buy.com/yanbao2/get?skuId=" + this.sku,dataType:
// "jsonp",success: function(e) {
// e && t.set(e)
// }})
    },set: function(t) {
...
// var t = "http://eve.jd.com/redirect.action?wid=" + G.sku + "&btype=0&r=" +
// Math.random(), e = $("#InitCartUrl");
...
// var t = $("#choose-btn-easybuy,#choose-btn-baitiao-fq,#nav-minicart");
       // pageConfig.product.specialAttrs.join("^"),
		...
		// t.remove(), pageConfig.product.isWeChatStock = !0
    }
    pageConfig.product.isClosePCShow && t()
}(), function() {
// var t = $("#choose-btn-easybuy"), e = ' <div id="choose-btn-baitiao-fq"
// clstag="shangpin|keycount|product|baitiao" class="btn"> <a href="#none"
// class="btn-baitiao-fq" style="width:100px"
// onclick="showBaitiaoFq(\'#Fqfk_Tip\')"
// clstag="shangpin|keycount|product|btn-dbt">\u767d\u6761/\u5206\u671f<b
// style="background:url(http://img10.360buyimg.com/da/jfs/t187/274/284523263/8856/bceb4ca8/5385bac9Nbc69d7f7.png)
// no-repeat"></b></a> </div>';
...
// i > 0 && $.getJSON(consultationServiceUrl, {method:
// "VoteForConsultation",productId: i,consultationId: s,score: a}, function(e) {
// e.Result ? ($(t).text("\u5df2\u6295\u7968"),
// $(t).next("span").text(parseInt($(t).next("span").text()) + 1)) :
// $(t).text("\u5df2\u6295\u7968")
// })
// }
    ...
    (function() {
       ...
       // pageConfig.disabledSeoBanner || (t.push("2_163_5395"),
		// t.push("2_163_5394")), 1315 === G.cat[0] && $("#Ad2_100_2272").length
		// > 0 && t.push("2_100_2272"), G.isPop && t.push("2_601_3951"),
		// $.ajax({url: "http://nfa.jd.com/loadFa_toJson.js?aid=" + t.join("-")
		// + "&ver=20131107",dataType: "script",cache: !0}),
		// insertScript("http://static.360buyimg.com/gemini/gemini/gemini_v2.2.1.js",
		// {id: "1399174259281",name: "gemini_divide_script",charset:
		// "utf-8",divideType: "MODULE_INJECT",param: "[{t:'xiaoyumi'}]"})
...
// var t = this, e = '<div id="m-buy"
// clstag="shangpin|keycount|product|btn-erweima"> <div
// class="mt">\u5ba2\u6237\u7aef\u9996\u6b21\u4e0b\u5355</div> <div
// id="m-countdown"> <strong class="hl_red">\u90015\u5143\u4eac\u5238</strong>
// </div> <div id="m-qrcode" class="hide"> <span class="close"
// onclick="$(\'#m-buy\').removeClass(\'hover\')"></span> <span
// class="arr"></span> <div class="m-qrcode-wrap">
// <strong>\u5ba2\u6237\u7aef\u9996\u5355\u6ee159\u90015\u5143\u4eac\u5238\u4f4e\u4ef7\u79d2\u6740\u5546\u54c1\u62a2\u4e0d\u505c</strong>
// <div id="m-qrcode-box"> <img
// src="http://misc.360buyimg.com/lib/img/e/blank.gif" width="155" height="155"
// /> </div> </div> </div></div>';
// return $("#m-buy").length > 0 ? !1 : (this.chooseBtn.append(e), this.mBuy =
// $("#m-buy"), this.mt = this.mBuy.find(".mt"), this.mBuy.Jdropdown({delay:
// 200,event: "click"}, function() {
// "true" !== t.mBuy.attr("loaded") && ($.ajax({url:
// "http://misc.360buyimg.com/product/js/2012/qrcode.js?ver=20140527",dataType:
// "script",scriptCharset: "gb2312",cache: !0}), t.mBuy.attr("loaded", "true"))
// }), void 0)
    },setProm: function(t) {
...
// e(t)
// }, $.ajax({url:
// "http://nfa.jd.com/loadFa_toJson.js?aid=2_163_4827-2_163_4828",dataType:
// "jsonp",cache: !0,success: function() {
// }})
